...
BRANDS = {
    ...
    "Casey's":         ("🍕", "store", r"^Casey'?s( General Store)?$"),
    "Circle K":        ("⛽", "store", r"^Circle K$"),
    "Royal Farms":     ("🍗", "store", r"^Royal Farms$"),
    "Meijer":          ("🛒", "store", r"^Meijer$"),
    "Hy-Vee":          ("🛒", "store", r"^Hy-?Vee$"),
    "Fred Meyer":      ("🛒", "store", r"^Fred Meyer$"),
    "Wegmans":         ("🛒", "store", r"^Wegmans$"),
    "Harris Teeter":   ("🛒", "store", r"^Harris Teeter$"),
    "Giant Eagle":     ("🛒", "store", r"^Giant Eagle$"),
    "Sprouts":         ("🥬", "store", r"^Sprouts( Farmers Market)?$"),
    "Dollar General":  ("🏪", "store", r"^Dollar General$"),
    "Tractor Supply":  ("🚜", "store", r"^Tractor Supply( Company)?$"),
    "Krispy Kreme":    ("🍩", "food",  r"^Krispy Kreme$"),
    "Cook Out":        ("🍔", "food",  r"^Cook ?Out$"),
    "Portillo's":      ("🌭", "food",  r"^Portillo'?s"),
